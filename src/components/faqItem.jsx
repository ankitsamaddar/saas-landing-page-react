  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        ...
        <div
          className={clsx(
            'faq-icon relative flex size-12 items-center justify-center text-xl border-2 border-s2 shadow-400 transition-all duration-500 group-hover:border-s4 rounded-full',
